      ...
      <div className={{}}>
        ...
        >
          ...
          >
            ...
            As a Software Engineer, I bring a diverse background with expertise
            in building Generative AI applications (Python, LLMs, Vectara, RAG),
            web applications (MERN), and mobile applications (React Native).
            Additionally, as a Tech Trainer, I have trained 1000+ students in
            various programming languages and technologies at{" "}
            <div className="relative inline-block">
              <a
                className="spanOneHoverClass text-[#64ffda] cursor-pointer font-calibri text-[20px] aboutScreen4:block"
