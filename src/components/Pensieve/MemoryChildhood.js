      ...
      <div className="w-[70%] mr-auto ml-auto mt-[40px] myScreen8:w-[100%]">
        ...
        >
          <p className="pl-[1.5em] leading-[1.5] text-[#a8b2d1] italic">
            My journey begins in a small village located in District
            Bahawalnagar, South Punjab, Pakistan, near the Indian border, on
            August 25, 2000. As the first boy in my family, my arrival brought
            immense joy to my parents, prompting my father to distribute sweets
            throughout the village. This blog post will delve into the early
            years of my life, highlighting the typical experiences of a Punjabi
            child growing up in a rural setting. Join me as I reminisce about
            the carefree days filled with village games, cricket, and cherished
            memories before my college years.Some of the memories that i never
            forgot are as follows
          </p>
        </div>
        {/* Listing */}
        <ul
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              Like many other Punjabi children in similar villages, my childhood
              was filled with the simple pleasures of life. I immersed myself in
              traditional village games, such as Gulli Danda, Kanchy, Ludo, Kite
              Flying, Kabbadi, Hide and Seek, Pitho Garam, and Chuppan Chupai.
              Among these, my passion for cricket burned the brightest. Playing
              cricket became a daily routine, and my love for the sport was
              unmatched. However, my devotion to cricket sometimes drew
              admonishment from my father, as I dedicated more time to playing
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              My early years of education followed the familiar pattern of most
              children in the village. I attended a private school up until the
              eighth grade and later joined a government school for my
              matriculation studies. Academic pursuits took a backseat to my
              cricket passion during this time. My friends especially{" "}
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo cursor-pointer">
                  sumair
                </span>
              </span>{" "}
              and I would occasionally skip classes to watch Pakistan cricket
              team matches on a small Samsung mobile outside the school
              premises. We found solace beneath the shade of trees, where we
              would sit and eagerly follow the games and also we often play
              cricket on brake time. These moments created lasting memories that
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              After school, I often accompanied my father to his fields. As a
              retired army personnel, he engaged in agricultural activities, and
              I would join him in the evenings. These fields became the backdrop
              for countless cricket matches with my friends. The joy of playing
              amidst the vast green expanse remains etched in my memory. As the
              sun set, we would reluctantly leave the fields, content with the
              camaraderie and competition we shared.
            </p>
          </div>
          {/* Image for First Listing Description */}
          <div className="mr-auto ml-auto mt-[40px]">
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              Nights in my village were filled with entertainment for the entire
              family. We would gather around the television to watch movies,
              drama serials on PTV, and spend quality time together. On
              occasion, I would venture out with my village friends to play
              Lukkan Chuppai. This game of hide-and-seek took on a unique twist,
              as we hid not only in houses but also in the vast fields, adding
              an extra element of thrill and excitement to our nighttime
              adventures. These carefree evenings fostered a sense of belonging
              and happiness within our close-knit community.
            </p>
          </div>
          {/* Image for First Listing Description */}
          <div className="mr-auto ml-auto mt-[40px]">
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              Reflecting upon my early life, I am grateful for the simple joys
              and experiences that shaped my journey. Growing up in a small
              village in South Punjab, Pakistan, surrounded by the bordering
              beauty of nature, I embraced the spirit of community, playfulness,
              and the pursuit of my passions. While my academic dedication may
              have wavered at times, my fervor for cricket remained unwavering,
              serving as a source of joy, camaraderie, and endless memories.
              These formative years taught me the importance of finding balance
              between responsibility and the pursuit of personal interests. They
              instilled in me a resilient spirit, encouraging me to forge my own
              path, even in the face of societal expectations. Through the bonds
              of friendship, the serenity of nature, and the thrill of
              competition, I discovered the power of dreams and the perseverance
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              "Childhood is a canvas upon which we paint memories that last a
              lifetime." -{" "}
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo cursor-pointer">
                  Ahmad Jajja
