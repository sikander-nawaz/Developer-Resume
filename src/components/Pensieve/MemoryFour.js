...
//             The year 2021 was a transformative period for me as I delved into
//             various fields of technology, faced challenges, made significant
//             decisions, and took steps towards achieving my career goals. In this
//             year in review, I will highlight the key events and experiences that
//             shaped my journey in artificial intelligence (AI), machine learning,
//             data science, and web development, as well as my exploration of data
//             structures and algorithms (DSA). Some of the things that happen with
//             me in this year are as follows
//           </p>
//         </div>
//         {/* Listing */}
//         <ul
...
//             <p>
//               Exploration of Artificial Intelligence, Machine Learning, and Data
//               Science
//             </p>
//           </li>
...
//               As 2021 began, I possessed strong coding, problem-solving, and
//               logic-building skills. However, I felt the need to move beyond
//               learning a specific coding language and explore new areas in
//               technology. Unsure of the next steps to take, I conducted
//               extensive research and sought guidance from various individuals.
//               One person who stood out was{" "}
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">Faizan</span>
//               </span>{" "}
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">Amin</span>
//               </span>{" "}
//               , a machine learning engineer, whom I connected with on Facebook.
//               With his guidance, I decided to venture into the field of AI.
//             </p>
//           </div>
//           <div
//             ref={refFirstListingDescription}
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               To gain a better understanding of AI, I reached out to numerous
//               experts in the field of data science, machine learning, and AI.
//               Through interactions with over a hundred individuals, I gained
//               valuable insights and knowledge. Starting as a beginner in
//               computer science and AI, I faced the challenge of grasping these
//               complex technologies. I enrolled in Andrew Ng's{" "}
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">
//                   "AI for Everyone"
//                 </span>
//               </span>{" "}
//               course on Coursera, which provided me with a solid theoretical
//               foundation in AI. However, I felt the need for further guidance
//               and decided to wait until I could physically attend university to
//               fully immerse myself in the AI field.
//             </p>
//           </div>
//           <div
//             ref={refFirstListingDescription}
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               During this time, I dedicated myself to learning about AI, data
//               science, machine learning, big data analytics,statistics and
//               mathematices necesary for this. It was a period of intense
//               self-study and exploration, as I sought to expand my knowledge and
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               My journey into data structures and algorithms (DSA) began when I
//               met a person named{" "}
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">Ali</span>
//               </span>{" "}
//               from Jhang via social media. He emphasized the importance of DSA
//               in cracking interviews with major tech companies like FAANG.
//               Intrigued by his insights, I decided to embark on learning DSA.
//               With a solid foundation in coding, particularly in C and C++, I
//               eagerly delved into the world of DSA.
//             </p>
//           </div>
//           <div
//             ref={refSecondDescription}
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               Ali, who recorded lectures on DSA, generously shared his knowledge
//               with our group of six individuals. I took a keen interest in the
//               lectures, especially the topic of linked lists. Through dedicated
//               effort, I became proficient in linked lists and proceeded to
//               explore other concepts, such as stacks, queues, graphs, and trees.
...
//                 </span>
//               </span>{" "}
//               in just two days. However, when I attempted to run the code on my
//               mobile using a C++ coding app, it failed to execute. This setback
//               initially disheartened me, but I persevered and discovered a bug
//               in the code the next day. When the code ran successfully, I
//               experienced a sense of triumph and realized my potential as a
//               coder. From that moment on, I never looked back.
//             </p>
//           </div>
//           <div
//             ref={refSecondDescription}
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               Despite not having a laptop due to the COVID-19 pandemic, I
//               continued to code using a mobile device to test and run my
//               programs. This period of exploration and learning in the field of
//               DSA laid a strong foundation for my future endeavors.
//             </p>
//           </div>
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               Driven by a deep passion for learning and technology, I felt
//               limited by the lack of guidance and a coding culture in my
//               hometown. Understanding the importance of being in an environment
//               conducive to growth as a software engineer, I made a life-changing
//               decision. I decided to leave my home and relocate to Faisalabad, a
//               city known for its tech industry, with the intention of pursuing
//               my career aspirations. This decision was based on the belief that
//               i read somewhere written on wall{" "}
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">
//                   "کہیں پہنچنے کے لئے، کہیں سے نکلنا ضروری ہے"
//                 </span>
//               </span>{" "}
//               means that to reach a new destination, one must leave their
//               current surroundings behind.
//             </p>
//           </div>
//           <div
//             ref={refThirdDescription}
...
//                 </span>
//               </span>{" "}
//               , a senior in the field of computer science whom I had connected
//               with. He graciously allowed me to stay in his flat in Faisalabad.
//               In May 2021, I arrived in Faisalabad, feeling grateful for Ahmad's
//               support, which helped me settle into this new city.
//             </p>
//           </div>
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               Upon my arrival in Faisalabad, I spent approximately 20 days
//               acquainting myself with the city and its technological landscape,
//               while also working odd jobs to sustain myself. One such job
//               involved working as an order taker at a restaurant. During my time
//               there, I had the serendipitous opportunity to interact with
//               developers who would pass by me on their way to a software company
//               located on the building's second floor. These encounters filled me
//               with excitement and a burning curiosity to learn more about the
//               world of technology. Consequently, I often engaged these
//               developers in conversations, seeking to understand their roles,
//               experiences, and paths to success. It was during these
//               interactions that a profound realization dawned on me -
...
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">
//                   order taker; my true calling lay in becoming a software
//                   engineer "
//                 </span>
//               </span>{" "}
//               Motivated by this epiphany, I made the difficult decision to
//               resign from my position after only eight days. This brief stint,
//               although modest, played a pivotal role in helping me recognize my
//               true identity and reignite my passion for technology. I will
//               always cherish this experience as a significant milestone in my
...
//             className={`contentContainer ${
//               isFifthListingDescription ? "show" : ""
//             } border-t-0 border-b-0 border-r-0 border-l border-[#64ffda] border-[1px]`}
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               After quitting my job, I decided to visit various software
//               companies in Faisalabad to gain exposure and insights into the
//               industry. During these visits, I had the opportunity to meet a
//               full-stack software engineer who provided valuable advice. He
//               emphasized that C++ was just one language to learn and encouraged
//               me to explore other technologies. While his words were initially
//               harsh, they served as a wake-up call, prompting me to take a new
//               direction.
//             </p>
//           </div>
...
//             className={`contentContainer ${
//               isSixthListingDescription ? "show" : ""
//             } border-t-0 border-b-0 border-r-0 border-l border-[#64ffda] border-[1px]`}
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               Despite not having my own laptop, I borrowed a friend's device and
//               began learning web development. I started by exploring{" "}
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">
//                   HTML and CSS
//                 </span>
//               </span>{" "}
//               , gradually expanding my knowledge in these areas. Around the same
//               time, I joined an online bootcamp on mobile application
//               development led by Naved Sarwar. Eager to enhance my skills, I
...
//                 </span>
//               </span>{" "}
//               in a month. With a relentless drive to excel, I dedicated over
//               eight hours a day to coding and honing my skills. The summer break
//               between my second and third semesters in 2021 provided the ideal
//               opportunity to fully immerse myself in coding, resulting in
//               substantial growth in my frontend development skills.
//             </p>
//           </div>
...
//             className={`contentContainer ${
//               isSeventhListingDescription ? "show" : ""
//             } border-t-0 border-b-0 border-r-0 border-l border-[#64ffda] border-[1px]`}
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               During the summer break between my second and third semester, I
//               received life-changing news. My roommate{" "}
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">
...
//                 </span>
//               </span>{" "}
//               , which offered a web and mobile development course. With only two
//               days remaining to apply, I seized the opportunity and applied for
//               the program. After successfully passing the admission test, I
//               became one of the 800 students selected from a pool of 4,000
//               applicants. Joining SMIT was a pivotal moment for me, as I
//               discovered a vibrant coding culture and a supportive learning
//               environment. At SMIT, I delved into HTML, CSS, Bootstrap 5,
//               JavaScript (ES6), TypeScript, React JS, Firebase, Firestore, Node
//               JS, MongoDB , Express JS, Git, and GitHub. I eagerly awaited each
//               class, driven by the desire to learn and grow alongside
...
//             className={`contentContainer ${
//               isEighthListingDescription ? "show" : ""
//             } border-t-0 border-b-0 border-r-0 border-l border-[#64ffda] border-[1px]`}
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               In September 2021, I started university onsite classes after
//               pandemic situation in third semester, excited to meet peers who
//               shared my passion for coding and technology. However, I soon
//               realized that the university lacked a coding culture, with minimal
//               interest among students in discussing coding-related topics.
//               Although I sought guidance from seniors, I found limited resources
//               and individuals truly excelling in the field. This realization led
//               me to understand that I had to forge my own path and take charge
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               During my third semester at university, I faced numerous
//               challenges. Balancing my university studies and maintaining a
//               satisfactory CGPA while simultaneously pursuing web development
//               proved to be demanding. Determined to succeed, I adopted a
//               rigorous schedule that involved waking up before dawn, typically
//               around 4 or 5 am. After the Fajr prayer, I would leave the hostel
//               and devote my entire day to intensive learning and coding. I would
//               return to the hostel late at night, around 1 AM, and allocate only
//               a few hours for sleep, typically four to five hours a night, with
//               minimal rest during the day. Balancing my university studies with
//               web development became a challenging task
//             </p>
//           </div>
...
//             className={`contentContainer ${
//               isNinthListingDescription ? "show" : ""
//             } border-t-0 border-b-0 border-r-0 border-l border-[#64ffda] border-[1px]`}
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               In 2021, I embarked on a transformative journey in coding and web
//               development. Despite challenges and a lack of guidance, I remained
//               determined, taking charge of my own learning. Joining Saylani Mass
//               IT Training Program provided a supportive community where I honed
//               my skills. Balancing university studies and coding, I persevered
//               with unwavering dedication. I am proud of the progress I have made
//               and the resilience I have developed. As I move forward, I carry
//               with me a strong belief in my abilities and a commitment to
//               continuous growth. The future holds boundless opportunities for me
