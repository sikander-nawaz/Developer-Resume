      ...
      <div className="w-[70%] mr-auto ml-auto mt-[40px] myScreen8:w-[100%]">
        ...
        >
          <p className="pl-[1.5em] leading-[1.5] text-[#a8b2d1] italic">
            The year 2022 was filled with various accomplishments, challenges,
            moments of joy, and moments of sadness. It marked a significant
            transition in my life as I navigated through different experiences
            and made choices that shaped my journey towards becoming a software
            engineer. This review will highlight some of the key events and
            milestones that defined my year are given below:
          </p>
        </div>
        {/* Listing */}
        <ul
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              As 2022 began, I found myself immersed in preparing for the final
              exams of my third semester, which were scheduled for the second
              week of January. The exams went well, and as the third and fourth
              semesters commenced, I started engaging more in activities
              unrelated to coding. I became involved with a circle of friends
              who were not interested in coding, and slowly but surely, I began
              to drift away from my passion. While the enjoyment I experienced
              with this new group was pleasant, I realized that compromising my
              dedication to coding was not beneficial for my long-term career
              goals. Unfortunately, none of my friends in this circle shared my
              enthusiasm for coding, which made it challenging to maintain my
              focus.
            </p>
          </div>
          <div
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              As the days went by, I noticed my passion for coding diminishing,
              despite my awareness that I possessed excellent coding skills at
              the time. These were difficult days for me as I started
              experiencing{" "}
              <span className="relative">
              ...
              . It became clear to me that I was not progressing towards my
              goals and dreams, which further exacerbated my state of mind. The
              journey to becoming a software engineer is not without its
              hardships, and during this period, I even missed grasping
              important concepts in some subjects.
            </p>
          </div>
          <div
            ref={refFirstListingDescription}
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              Realizing that I needed to break free from this situation, I made
              the decision to distance myself from my friend circle. This meant
              separating from a close friend named{" "}
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo ">Awais</span>
              </span>{" "}
              , whom I considered a brother. It was a heartbreaking choice, but
              the circumstances surrounding our friendship had become toxic, and
              I understood that I needed to move forward without him. Letting go
              of the past, I embarked on a new chapter in my life. This{" "}
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo ">
                  transition
                </span>
              </span>{" "}
              marked a significant turning point for me, as I was determined to
              leave behind all distractions and focus solely on my journey
              towards becoming a software engineer. Although it may sound simple
              as I write about it now, the process of letting go and making
              these changes was not easy.
            </p>
          </div>
          <div
            ref={refFirstListingDescription}
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              I stepped down from my position as the Class Representative (CR)
              of my class, a responsibility I had held for four semesters.
              ...
              for the next three months, minimizing my use of mobile devices to
              avoid unnecessary distractions. These choices were not made
              lightly, but I recognized their importance in reshaping my path
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              With the end of the fourth semester and the arrival of the summer
              break, I dedicated myself to working tirelessly to regain my
              momentum. I committed to coding for extended periods, sometimes
              investing{" "}
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo ">
              ...
              to compensate for the time I had lost during the previous four
              months. It was crucial for me to cover the subjects and concepts I
              had missed, such as operating systems, data structures, and
              algorithms. During this period, my passion for coding burned
              brighter than ever before, fueling my determination and propelling
              me forward on my journey towards becoming a software engineer.
            </p>
          </div>
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              During the summer break between my fourth and fifth semesters, I
              decided to pursue an internship as a MERN Stack developer at
              Seeraht. During that time i worked under the supervision of{" "}
              <span className="relative">
                <a
                  href="https://umairahmad.net/"
                  target="_blank"
                  className="text-[#64ffda] viewArchiveTwo cursor-pointer"
                >
                  Sir Umair Ahmad
                </a>
              </span>{" "}
              . This internship proved to be a rigorous and transformative
              experience. I dedicated myself entirely to coding, even to the
              point where coding occupied my thoughts even during sleep.
              Throughout the internship, I worked on various projects, including
              a bank app and an e-commerce mobile app, while also gaining
              experience in maintaining existing projects. This period allowed
              me to sharpen my skills and gain practical industry experience.
            </p>
          </div>
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              In August 2022, a 12-hour hackathon was organized at Saylani Mass
              IT Training (SMIT), specifically for students who had enrolled in
              the web and mobile app development course the previous year. The
              hackathon presented the challenge of building a Real Estate Mobile
              App within the given timeframe. Out of the 70 students who
              participated, I was among the{" "}
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo ">top five</span>
              </span>{" "}
              , which was a significant achievement considering the initial pool
              of 800 students who had enrolled in the course. This experience
              not only showcased my abilities but also taught me valuable
              lessons in learning how to learn effectively.
            </p>
          </div>
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              Following my departure from my previous company, I had the fortune
              of meeting a friend named{" "}
              <span className="relative">
                <a
              ...
              during my time at Saylani Mass IT Training. We shared a similar
              passion for coding and became great companions in our journey.
              Another person who significantly influenced my career path was my
              roommate,{" "}
              <span className="relative">
                <a
              ...
              , who was also a MERN developer and focused on data structures and
              algorithms. Their presence provided me with the necessary support
              and motivation to pursue my goals. Surrounding myself with
              like-minded individuals proved instrumental in my progress.
            </p>
          </div>
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              After dedicating an entire year to SMIT, attending the hackathon,
              and achieving a commendable position, I was honored to receive the
              Full Stack Web and Mobile Developer Certification from{" "}
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo ">
                  Hazrat Allama Maulana Muhammad Bashir Farooqi
                </span>
              </span>{" "}
              , the founder of Saylani Mass IT Training. This certification not
              only represented my technical skills but also symbolized the
              culmination of my year-long journey and the immense effort I had
              put into my studies.
            </p>
          </div>
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              With the announcement of the PIAIC (Pakistan's Institute of
              Artificial Intelligence and Computing) offering a course on Web
              3.0 and Metaverse, my excitement knew no bounds. Joining PIAIC and
              gaining guidance from this prestigious platform became a key
              objective for me. Despite the initial disappointment of admissions
              not being opened in Faisalabad, I made a decision to travel to
              Lahore from Faisalabad every Sunday at the morning time with{" "}
              <span className="relative">
                <a
                  href="https://github.com/AbuHurairah127"
                  target="_blank"
              ...
              to attend classes and returning back Faisalabad on night time on
              the same day. This marked the beginning of a new chapter, focused
              on expanding my knowledge in cutting-edge technologies.
            </p>
          </div>
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              Recognizing my performance throughout my time at Saylani Mass IT
              Training and my success in the hackathon, I was offered an
              opportunity to train students in the next batch starting in
              December 2022. Teaching became an enriching experience for me,
              allowing me to enhance my skills while guiding and inspiring these
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              In the same year, I commenced my employment as a MERN Stack
              Developer at a reputable software company in Faisalabad. My role
              primarily involved working on a significant project for a client
              based in the UAE. This project focused on creating a platform akin
              to LinkedIn, specifically designed to streamline the employee
              hiring process. Throughout my tenure, I had the privilege of being
              mentored by{" "}
              <span className="relative">
                <a
                  href="https://www.linkedin.com/in/waleedumer42/"
                  target="_blank"
                  className="text-[#64ffda] viewArchiveTwo cursor-pointer"
                >
                  Waleed Umar
              ...
              , whose invaluable guidance and insights greatly influenced my
              professional journey. Waleed provided me with constructive
              feedback, highlighting my strengths and weaknesses, contributing
              to my personal and technical development.
            </p>
          </div>
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              In conclusion, the year 2022 was a period of immense growth,
              challenges, and accomplishments. It was a year of self-reflection,
              resilience, and determination as I navigated through various
              experiences and pursued my passion for software engineering. The
              journey was not without its obstacles, but each hurdle served as a
              stepping stone towards my goals. Through internships, hackathons,
              certifications, and valuable connections, I gained valuable skills
              and knowledge that propelled me forward. The support and guidance
              of mentors and the opportunity to contribute to meaningful
              projects have been instrumental in shaping my path. As I look back
              on this transformative year, the following quote resonates with
              me:
            </p>
          </div>
          <div
