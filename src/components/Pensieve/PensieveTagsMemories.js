          ...
          <span className="relative">
            <a
              ...
              className={`font-calibri text-[24px] cursor-pointer font-semibold leading-[1.1] ease-whereIWorkedTransitionTiming transition-whereIWorkedTransitionProperty duration-whereIWorkedTransitionDuration viewArchiveTwo ${
                zerothMemoryHoverUp ? "text-[#64ffda]" : "text-[#a8b2d1]"
              }`}
            >
              Early Life in a Small Village
            </a>
        ...
        <div>
          <span className="relative">
            <a
              ...
              className={`font-calibri text-[24px] cursor-pointer font-semibold leading-[1.1] ease-whereIWorkedTransitionTiming transition-whereIWorkedTransitionProperty duration-whereIWorkedTransitionDuration viewArchiveTwo ${
                thirdMemoryHoverUp ? "text-[#64ffda]" : "text-[#a8b2d1]"
              }`}
            >
              Year in Review 2020
            </a>
        ...
        <div>
          <span className="relative">
            <a
              ...
              className={`font-calibri text-[24px] cursor-pointer font-semibold leading-[1.1] ease-whereIWorkedTransitionTiming transition-whereIWorkedTransitionProperty duration-whereIWorkedTransitionDuration viewArchiveTwo ${
                fourthMemoryHoverUp ? "text-[#64ffda]" : "text-[#a8b2d1]"
              }`}
            >
              Year in Review 2021
            </a>
        ...
        <div>
          <span className="relative">
            <a
              ...
              className={`font-calibri text-[24px] cursor-pointer font-semibold leading-[1.1] ease-whereIWorkedTransitionTiming transition-whereIWorkedTransitionProperty duration-whereIWorkedTransitionDuration viewArchiveTwo ${
                fifthMemoryHoverUp ? "text-[#64ffda]" : "text-[#a8b2d1]"
              }`}
            >
              Year in Review 2022
            </a>
