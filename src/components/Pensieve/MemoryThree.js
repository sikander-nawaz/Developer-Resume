      ...
      <div className="w-[70%] mr-auto ml-auto mt-[40px] myScreen8:w-[100%]">
        ...
        >
          <p className="pl-[1.5em] leading-[1.5] text-[#a8b2d1] italic">
            The year 2020 brought about significant changes and important
            decisions in my life. From the outbreak of the Covid-19 pandemic to
            selecting a field of study for my bachelor's degree, navigating
            university admissions, and embarking on the journey of learning
            programming languages, this year was filled with transformative
            experiences. Some of the things that happen with me in this year are
            as follows
          </p>
        </div>
        {/* Listing */}
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              As the year commenced, I dedicated myself to preparing for my
              12th-grade exams, with aspirations of achieving high marks for
              university admissions. My days were packed with intense studying,
              attending college classes, and engaging in extracurricular
              activities such as playing cricket. However, the outbreak of the
              Covid-19 pandemic disrupted the education system, and the board
              exams were canceled. Despite initial disappointment, I accepted
              the decision and turned my attention to contemplating my future
              university plans.
            </p>
          </div>
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              With the cancellation of exams, I was prompted to think creatively
              about my career path. After seeking advice from my teachers,
              cousins, and conducting extensive research, I made the decision to
              pursue coding as my career. Having acquired a solid foundation in
              computer science during my previous two years of study, I felt
              confident in this choice. I resolved to pursue a bachelor's degree
              in computer science, recognizing the tremendous potential and
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              Once I had determined my career path, the next step was selecting
              a university. Extensive research led me to consider various
              options, and initially, I was shortlisted for admission to
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo">
                  the Islamia University Bahawalpur
                </span>
              </span>
              . However, due to personal reasons, I was unable to submit my
              documents in time and missed the opportunity. Nonetheless, I
              persevered and soon found another opportunity by being shortlisted
              and submitting my documents to
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo">
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              Upon arriving in Faisalabad, a city far from my hometown, I
              experienced a sense of excitement and unfamiliarity. It felt like
              stepping into a different world. During my university's
              Orientation Day, I had a life-changing encounter with a remarkable
              individual named
              <span className="relative">
                <a
                  href="https://github.com/faizan170"
                  target="_blank"
              ...
              . Despite being only two years older than me, Faizan was already a
              successful Machine Learning Engineer, earning a salary twice that
              of doctors. His expertise and success inspired me greatly, and our
              brief interaction left a lasting impact. From that moment, I felt
              assured that I had chosen the right path and embarked on my
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              As my university classes began, I was surprised to discover that
              the curriculum included only one computer science-related subject
              out of six, with the remaining subjects focusing on non-technical
              areas such as physics and mathematics. Recognizing the need to
              pursue coding independently, I
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo">
                  took the initiative to learn C++
                </span>
              </span>
              programming on my own. In just twelve days, I grasped the
              fundamental concepts of both procedural and object-oriented
              programming paradigms. While my university did not offer a
              dedicated coding course, my friends from other institutions shared
              their coding assignments with me, providing opportunities to
              enhance my
              <span className="relative">
                <span className="text-[#64ffda] viewArchiveTwo ">
              ...
              . Although there were challenges along the way, such as
              experiencing delayed payment for completing a client's C++
              assignment, the satisfaction of solving complex problems
              outweighed any monetary reward.
            </p>
          </div>
          {/* Image for First Listing Description */}
          <div className="mr-auto ml-auto mt-[40px]">
        ...
        <div>
          ...
          >
            <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
              The year 2020 was a transformative period marked by the onset of
              the Covid-19 pandemic, decision-making processes, university
              admissions, and the initiation of my coding journey. It challenged
              me to adapt, reflect, and make choices that would shape my future.
              As I look back on this year, a quote come to mind:
            </p>
          </div>
          <div
            ref={refSixthDescription}
