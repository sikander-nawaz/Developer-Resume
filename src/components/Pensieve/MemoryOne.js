...
//             In the year 2018, my life took an unexpected turn as I faced a
//             setback in my biology studies. This disappointment led me to make a
//             significant decision for my future, choosing a tech journey in the
//             field of computer science. Despite societal pressures and the allure
//             of other career paths, I embarked on the path of computer science,
//             and my journey began to unfold. This year marked the beginning of a
//             transformative period in my life, where I discovered my passion for
//             technology and made sacrifices to pursue it. Some of the things that
//             happen with me in this year are as follows
//           </p>
//         </div>
//         {/* Listing */}
//         <ul
...
//               The journey towards computer science truly began when my
//               10th-grade biology results came in, leaving me dissatisfied with
//               my performance. Although I had passed, I felt compelled to
//               redirect my career aspirations away from the field of biology. It
//               was a moment of self-reflection and realization that prompted me
//               to explore other options that resonated more with my interests and
//               skills.
//             </p>
//           </div>
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               The pivotal moment in my academic trajectory came when I faced the
//               reality of my biology failure. This was a shocking revelation for
//               me on that time, as most of my relatives were pursuing medical
//               careers, and there was a prevailing belief that success could only
//               be achieved through becoming a doctor. However, I chose to deviate
//               from this conventional path and instead selected the field of
//               computer science for my career.
//             </p>
//           </div>
//           <div
//             ref={refSecondDescription}
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               As I embarked on my educational journey after 10th grade, I had
//               three options to choose from for my 12th grade (Intermediate)
//               studies: ICS (Computer Science, Math, Physics), FSC Pre-Medical
//               (Biology, Chemistry, Physics), and FSC Pre-Engineering (Chemistry,
//               Physics, Math). Given my unsatisfactory performance in biology and
//               lack of interest in chemistry, I opted for ICS, as it aligned with
//               my passion for computer science. Although my relatives and family
//               members encouraged me to pursue FSC, I firmly rejected their
//               advice and followed my own aspirations, despite the uncertainty
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               As I stepped into college, I encountered an environment that
//               differed greatly from what I had anticipated. The relaxed
//               atmosphere, lack of attendance requirements, and less-than-stellar
//               teachers initially left me disheartened. However, a fortuitous
//               encounter with a computer science teacher named
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo cursor-pointer">
//                   Sir Ishaq
//                 </span>
//               </span>
//               proved to be a turning point. His exceptional teaching skills and
//               passion for the subject sparked a newfound interest within me.
//               Regular attendance became a priority as I delved deeper into the
//               world of computer science and began to understand its intricacies.
//             </p>
//           </div>
//           {/* Image for First Listing Description */}
//           <div className="mr-auto ml-auto mt-[40px]">
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               In 2018, my passion for cricket was at its peak. I
//               enthusiastically organized cricket tournaments in my village and
//               actively participated in matches held in various neighboring
//               communities. My dream of joining the national cricket team as a
//               batsman burned brightly within me. However, the realization dawned
//               upon me that I lacked the necessary support from my family to
//               pursue a career in cricket. It was during this period that my
//               uncle, my father's brother, provided me with invaluable guidance.
//               He reminded me of my role as the elder brother within our family
//               and emphasized the importance of supporting and making them proud.
//               It became evident that pursuing cricket would not lead me to the
//               international stage or enable me to join a cricket academy.
//               Determined to honor my responsibilities, I made the difficult
//               decision to relinquish my dreams of cricket stardom and focus
//               wholeheartedly on my studies. It was then that I crossed paths
//               with computer science, which ignited a new sense of purpose and
//               set me on the course towards my true passion.
//             </p>
//           </div>
//           {/* Image for First Listing Description */}
//           <div className="mr-auto ml-auto mt-[40px]">
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               Throughout my journey, I encountered setbacks and sacrifices.
//               Giving up my dreams of becoming a cricketer was particularly
//               difficult, but it allowed me to prioritize my family's well-being
//               and take on the role of a responsible elder sibling. By
//               redirecting my focus towards my studies, I discovered a newfound
//               love for computer science and began to nurture my interest in this
//               fascinating field.
//             </p>
//           </div>
//           <div
