...
//             In 2019, I experienced remarkable achievements in my computer
//             science journey, securing top positions among my peers and excelling
//             in the 11th-grade board exam. Additionally, I embraced the world of
//             programming with enthusiasm, discovering a passion that continues to
//             drive me forward. Some of the things that happen with me in this
//             year are as follows
//           </p>
//         </div>
//         {/* Listing */}
...
//               In 2019, my journey took an exceptional turn when I received the
//               results of my 11th grade. Despite being initially overshadowed by
//               the academic performance of 150 students who had higher marks than
//               me in the 10th grade, I surpassed expectations and secured the 6th
//               position among a total of 250 students in my college. Moreover, I
//               proudly achieved the 1st position in the ICS (Intermediate in
//               Computer Science) batch, setting a remarkable milestone for
//               myself. A significant highlight of this accomplishment was scoring
//               an astonishing 74 out of 75 marks in the computer science subject
//               11th-grade board exam, becoming the first student in the history
//               of my college, under the guidance of Sir Ishaq, to achieve such an
//               exceptional result. This unexpected achievement not only left me
//               astounded but also instilled a newfound belief in my capabilities,
//               as I embarked on my journey in computer science.
//             </p>
//           </div>
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               At the commencement of my second year (12th grade) in college, I
//               was apprehensive about the inclusion of
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo ">
//                   programming
//                 </span>
//               </span>
//               , particularly the C language, in our curriculum. This concern was
//               further amplified by the remarks of other college students who
//               claimed that programming was an arduous task. However, on the
//               first day of my second year, I sought solace in a conversation
//               with my cousin, Babar, who had completed his BCS (Bachelor of
//               Computer Science). He reassured me, in Urdu, that
//               {"  "}
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo">
...
//                 </span>
//               </span>
//               which translates to "Programming is fun and very easy." This
//               single sentence provided immense relief and ignited my curiosity
//               and fascination with the world of programming, marking
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo ">
...
//                 </span>
//               </span>
//               for the past three months, a remarkable moment unfolded. I vividly
//               remember encountering a problem-solving exercise in my C language
//               book that focused on the If-else concept. Intrigued, I decided to
//               approach the problem from a different angle and worked through it
//               diligently, using pen and paper, as I did not possess a computer
//               to test my solution. The following day, I excitedly approached my
//               teacher and shared my alternative approach, eager to validate its
//               correctness. With his guidance, I
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo ">
//                   ran the code on a computer
//                 </span>
//               </span>
//               , and to my astonishment, it executed flawlessly.
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo ">
//                   The indescribable elation I experienced in that moment was
//                   priceless
//                 </span>
//               </span>
//               , fueling my growing interest in coding. Subsequently, I began
//               solving other problems in the book independently, immersing myself
//               in its contents. Through meticulous study, I acquired a
//               comprehensive understanding of the C language and the concepts of
//               relational databases, laying a solid foundation upon which I
//               continued to build.
//             </p>
//           </div>
//           {/* Image for First Listing Description */}
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               Throughout my journey of 2019, I experienced significant growth
//               and accomplishments in academics and programming. These milestones
//               fueled my passion and set the stage for a promising future in
//               computer science.
//             </p>
//           </div>
//           <div
...
//           >
//             <p className="my-[1em] leading-[1.5] text-[#a8b2d1] italic text-[18px] font-calibri pl-[1.5em] antialiased">
//               "Truly willing to do something automatically embrace the new
//               doors." -
//               <span className="relative">
//                 <span className="text-[#64ffda] viewArchiveTwo ">
//                   Ahmad Jajja
