                  ...
                  <div>
                    ...
                    <div className="pt-[2.3rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      ...
                      <div className="leading-[1.22rem]">
                        As a Co-Founder, I'm putting my best efforts with my
                        team into making <b>EcoFactor</b> a reality.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        <b>As a Dev Lead</b>, my focus is on the development
                        side of our project EcoFactor. I'm handling front-end,
                        AI integration, and backend with my team. We, as Dev
                        members, are working collaboratively on this project.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        <b>EcoFactor</b> currently consists of a team of 7
                        members: 4 from Pakistan, 2 from Brazil, and 1 from
                        Latvia.
                      </div>
                    </div>
                  </div>
                ...
                <div className="blink_me transition-all delay-whereIWorkerdTransitionFinalDelay">
                  <div>
                    ...
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Focused on enhancing my generative AI skills through
                        these hackathons by building something cool.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Embraced the advent of ChatGPT, recognizing that
                        everyone has equal opportunities in generative AI.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        It's worth spending time in hackathons to create truly
                        amazing and innovative projects using generative AI,
                        LLMs, and other AI technologies.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Spent time in hackathons to create truly amazing and
                        innovative projects using generative AI, LLMs, and other
                        AI technologies.
                      </div>
                    </div>
                  </div>
                ...
                <div className="blink_me transition-all delay-whereIWorkerdTransitionFinalDelay">
                  <div>
                    ...
                    <div className="pt-[2.3rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Trainer and moderator at 𝐢𝐂𝐨𝐝𝐞𝐆𝐮𝐫𝐮 platform, with
                        20,000+ 𝐦𝐞𝐦𝐛𝐞𝐫𝐬.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Teaching 𝐏𝐲𝐭𝐡𝐨𝐧 𝐩𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐢𝐧𝐠 𝐥𝐚𝐧𝐠𝐮𝐚𝐠𝐞 and 𝐃𝐒𝐀 𝐭𝐡𝐫𝐨𝐮𝐠𝐡
                        𝐋𝐞𝐞𝐭𝐂𝐨𝐝𝐞.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Conducting 𝐰𝐞𝐞𝐤𝐥𝐲 𝐰𝐨𝐫𝐤𝐬𝐡𝐨𝐩𝐬 on key DSA topics to help
                        underprivileged students learn freely.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Voluntarily taught the 𝐃𝐮𝐨𝐥𝐢𝐧𝐠𝐨 𝐄𝐧𝐠𝐥𝐢𝐬𝐡 𝐏𝐫𝐨𝐟𝐢𝐜𝐢𝐞𝐧𝐜𝐲 𝐓𝐞𝐬𝐭
                        to students.
                      </div>
                    </div>
                    {/* 1 */}
                ...
                <div className="blink_me transition-all delay-whereIWorkerdTransitionFinalDelay">
                  <div>
                    ...
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Providing instructions in HTML5, CSS3, SCSS, SASS,
                        Bootstrap 5, JavaScript ES6+, TypeScript, React JS
                        (Context API, Router, State Management), React Native,
                        Redux, Firebase, Firestore, Node JS (ExpressJS,
                        Authentication, API Endpoint Handling), MongoDB, Heroku,
                        Surge, Netlify (Hosting), Git, Github.
                      </div>
                    </div>
                    <div className="pt-[1.5rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="leading-[1.22rem]">🔄 Courses</div>
                    </div>
                    {/* 1 */}
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div
                  ...
                  <div>
                    ...
                    <div className="pt-[2.3rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      ...
                      <div className="leading-[1.22rem]">
                        ...
                        for 𝐒𝐭𝐚𝐧𝐟𝐨𝐫𝐝’𝐬 𝐂𝐨𝐝𝐞 𝐢𝐧 𝐏𝐥𝐚𝐜𝐞 to teach 𝐏𝐲𝐭𝐡𝐨𝐧 to
                        international students in groups of 10-15.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        ...
                        for 𝐨𝐧𝐞-𝐨𝐧-𝐨𝐧𝐞 𝐬𝐭𝐮𝐝𝐞𝐧𝐭 𝐬𝐮𝐩𝐩𝐨𝐫𝐭 and taught 56 𝐓𝐞𝐚𝐜𝐡𝐍𝐨𝐰
                        𝐬𝐞𝐬𝐬𝐢𝐨𝐧𝐬.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        I helped 100+ 𝐢𝐧𝐭𝐞𝐫𝐧𝐚𝐭𝐢𝐨𝐧𝐚𝐥 𝐟𝐨𝐥𝐤𝐬 worldwide, including
                        countries like the 𝐔𝐒𝐀, 𝐂𝐚𝐧𝐚𝐝𝐚, 𝐑𝐮𝐬𝐬𝐢𝐚, 𝐭𝐡𝐞 𝐔𝐊, 𝐈𝐧𝐝𝐢𝐚,
                        𝐁𝐚𝐧𝐠𝐥𝐚𝐝𝐞𝐬𝐡, 𝐁𝐫𝐚𝐳𝐢𝐥, 𝐆𝐞𝐫𝐦𝐚𝐧𝐲, and others.
                      </div>
                    </div>
                    <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                      <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                      <div className="leading-[1.22rem]">
                        Observed students aged 18-80, showcasing 𝐮𝐧𝐢𝐯𝐞𝐫𝐬𝐚𝐥
                        𝐢𝐧𝐭𝐞𝐫𝐞𝐬𝐭 𝐢𝐧 𝐩𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐢𝐧𝐠, even among those 𝐨𝐯𝐞𝐫 60.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="blink_me transition-all delay-whereIWorkerdTransitionFinalDelay">
                <div>
                  ...
                  <div className="pt-[2.3rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                    <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                    <div className="leading-[1.22rem]">
                      As a Co-Founder, I'm putting my best efforts with my team
                      into making EcoFactor a reality.
                    </div>
                  </div>
                  <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                    <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                    <div className="leading-[1.22rem]">
                      As a Dev Lead, my focus is on the development side of our
                      project EcoFactor. I'm handling front-end, AI integration,
                      and backend with my team. We, as Dev members, are working
                  ...
                  <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                    <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                    <div className="leading-[1.22rem]">
                      EcoFactor currently consists of a team of 7 members: 4
                      from Pakistan, 2 from Brazil, and 1 from Latvia.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="blink_me transition-all delay-whereIWorkerdTransitionFinalDelay">
                <div>
                  ...
                  <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                    <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                    <div className="leading-[1.22rem]">
                      Focused on enhancing my generative AI skills through these
                      hackathons by building something cool.
                    </div>
                  </div>
                  <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                    <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                    <div className="leading-[1.22rem]">
                      Embraced the advent of ChatGPT, recognizing that everyone
                      has equal opportunities in generative AI.
                    </div>
                  </div>
                  <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                    <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                    <div className="leading-[1.22rem]">
                      It's worth spending time in hackathons to create truly
                      amazing and innovative projects using generative AI, LLMs,
              ...
              <div className="blink_me transition-all delay-whereIWorkerdTransitionFinalDelay">
                <div>
                  ...
                  <div className="pt-[2.3rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
                    <div className="text-[#64ffda] pr-[1rem]">➾</div>{" "}
                    <div className="leading-[1.22rem]">
                      Trainer and moderator at 𝐢𝐂𝐨𝐝𝐞𝐆𝐮𝐫𝐮 platform, with 20,000+
                      𝐦𝐞𝐦𝐛𝐞𝐫𝐬.
                    </div>
                  </div>
                  <div className="pt-[1rem] text-[#8892b0] font-calibri text-[18px] antialiased flex">
